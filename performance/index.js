...
const mongoURI = 'mongodb+srv://Pranjan:pranjan123@cluster0.4sg7z.mongodb.net/stackanalyzer?retryWrites=true&w=majority';
...
app.get('/firebase', (req, res) => {
  ...
  // Example: querying a collection
  firestoreDB.collection('mycollection').get()
    .then((snapshot) => {
